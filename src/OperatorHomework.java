...
public class OperatorHomework {
    public static void main(String[] args) {
        ...
        float result = (float) ( ( (a + (-b)) * c / ((d % (--e)) - x) ) - (y * (z % w ) ) );
        ...
        ( ( (a + -11) * c / ((d % 1111) - x) ) - (y * (z % w ) ) );

        2. (d % (--e) = - 1 ; (a + - b) & (d % 1111) & (z % w) has same brackets so according the pemdas the order of precedence should be like (d % 1111) - (z % w ) - (a + -b)
        ( ( (a + -10) * c / (-1 - x) ) - (y * (z % w ) ) );
        ( ( (a + -10) * c / (-1 - x) ) - (y * 1.25 ) ); I don't know why but java printing the first number in this operation as a result, if the first number lower than second number.

...
public class Main {
    public static void main(String[] args) {
        ...
        personOverride.setEmail("bahadirtasli@gmail.com");
        System.out.println(personOverride.getEmail());

        Passenger passengerOverride = new Passenger();
        passengerOverride.setEmail("bahadirtasli@gmail.com");
        ...
        //passing parameters
        Passenger passanger2 = new Passenger(123456L,"Tallin",PaymentType.CASH,"Tartu");
        printPersonAddress(passanger2);
        printPersonAddressWithPrefix("Person", passanger2);
        ...
        System.out.println("Distance of" + Planet.JUPITER.name() + "from Earth : " + Planet.JUPITER.distanceFromEarth());

...
public class Main {
    ...
    private static int getMenu(){
        ...
        List<String> menu = List.of("Add item","Delete item", "Display all", "Exit");
    ...
    private static void deleteItem(List<String> shoppingBag) {
        ...
        while (isDelete) {
            System.out.println("Enter an item name to be deleteed to the bag: ");
            String deleteItem = SCANNER.next();

            if (shoppingBag.contains(deleteItem)) {
                shoppingBag.remove(deleteItem);
                System.out.println("'" + deleteItem + " ' deleteed to the bag. Do you want to delete more item?");
            } else {
    ...
    private static void displayItems(List<String> shoppingBag) {
        ...
        for (int i = 0; i < shoppingBag.size(); i ++) {
            ...
            if (thisItem.startsWith("m") || thisItem.startsWith("M") || shoppingBag.get(i).startsWith("m") || shoppingBag.get(i).startsWith("M")) {
